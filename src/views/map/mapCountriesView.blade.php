        ...
        <div class="form card">
            ...
            <div class="row">
                <div class="col-12 col-sm-7 col-md-6">
                    ...
                    <a href={{url(strtolower(config('yarm.sys_name')) . '/visualisations/searchFormRefine?form=MapCountries')}}>{{Form::button(__('Change Search'),['class'=>'btn btn-primary'])}}</a>
                        ...
                        <div class="card-body p-2">
                            <h5 class="card-title">
                                ...
                                <a title="Info" data-toggle="popover" data-trigger="hover"
                                   data-content="@lang('You can set options to change the chart. For Example choose another theme.')"><i
                                        class="fa fa-info-circle"
                                        style="color: grey"></i></a></h5>

                            <div class="current-path hidden" id="MapCountries"></div>
                            ...
                            <div style="padding-top: 5%">
                                <a href="{{route('excelMapCountries')}}">{{Form::button(__('Export to Excel'),['class'=>'btn btn-primary'])}}</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="listing-container" id="listing-container">
                ...
                @endif
                    <p style="text-align: center"><a title="Info" data-toggle="popover" data-trigger="hover"
                                                 data-content="@lang('When there is no specific data for your selection, the years will automatically adjust.')"><i
