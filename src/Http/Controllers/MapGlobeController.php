...
class MapGlobeController extends Controller
{
    ...
    public static function showData(Request $request)
    {
        ...
        try {
            ...
            return Redirect::to('/' . strtolower(config('yarm.sys_name')) . '/visualisations/searchForm?form=MapGlobe')->with('alert-danger', trans('No results with this search criteria!'));
        }
    }
